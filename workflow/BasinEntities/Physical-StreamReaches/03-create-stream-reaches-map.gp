# Create a GeoMapProject file for stream reaches for the Big Thompson Basin:
...
CreateGeoMap(NewGeoMapID="StreamReachesMap",Name="Stream Reaches",Description="Stream Reaches",CRS="EPSG:4326",Properties="extentInitial:'ZoomLevel:-105.4,40.43,10',docPath:stream-reaches-map.md")
